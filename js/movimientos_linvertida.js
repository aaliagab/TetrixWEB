...
export function moveDown() {
    if (rotacion == 0) {
        if (canDown()) {
            ...
            document.getElementById('img-' + (fila_inicial + 2) + '-' + (columna_inicial)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 2) + '-' + (columna_inicial + 1)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 2) + '-' + (columna_inicial + 2)).className = 'cazul';
            fila_inicial++;
        ...
        if (canDown()) {
            ...
            document.getElementById('img-' + (fila_inicial + 3) + '-' + (columna_inicial)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 3) + '-' + (columna_inicial + 1)).className = 'cazul';
            fila_inicial++;
            if (!canLeft() && !canRight() && !canDown()) {
                iniciarNuevaFigura();
            }
        ...
        if (canDown()) {
            ...
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial + 1)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 2) + '-' + (columna_inicial + 2)).className = 'cazul';
            fila_inicial++;
            if (!canLeft() && !canRight() && !canDown()) {
                iniciarNuevaFigura();
...
export function moveLeft() {
    if (rotacion == 0) {
        if (canLeft()) {
            document.getElementById('img-' + (fila_inicial) + '-' + (columna_inicial)).className = 'cnone';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial + 2)).className = 'cnone';
            document.getElementById('img-' + (fila_inicial) + '-' + (columna_inicial - 1)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial - 1)).className = 'cazul';
            columna_inicial--;
        ...
        if (canLeft()) {
            ...
            document.getElementById('img-' + (fila_inicial) + '-' + (columna_inicial)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 2) + '-' + (columna_inicial - 1)).className = 'cazul';
            columna_inicial--;
...
export function moveRight() {
    if (rotacion == 0) {
        if (canRight()) {
            ...
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial)).className = 'cnone';
            document.getElementById('img-' + (fila_inicial) + '-' + (columna_inicial + 1)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial + 3)).className = 'cazul';
            columna_inicial++;
        ...
        if (canRight()) {
            ...
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial + 1)).className = 'cnone';
            document.getElementById('img-' + (fila_inicial + 2) + '-' + (columna_inicial)).className = 'cnone';
            document.getElementById('img-' + (fila_inicial) + '-' + (columna_inicial + 2)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial + 2)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 2) + '-' + (columna_inicial + 2)).className = 'cazul';
            columna_inicial++;
        ...
        if (canRight()) {
            document.getElementById('img-' + (fila_inicial) + '-' + (columna_inicial)).className = 'cnone';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial + 2)).className = 'cnone';
            document.getElementById('img-' + (fila_inicial) + '-' + (columna_inicial + 3)).className = 'cazul';
            document.getElementById('img-' + (fila_inicial + 1) + '-' + (columna_inicial + 3)).className = 'cazul';
            columna_inicial++;
            if (fila_inicial == 14 && columna_inicial == 10 && !canLeft()) {
                iniciarNuevaFigura();
